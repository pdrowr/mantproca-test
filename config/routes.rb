Rails.application.routes.draw do
  localized do
    ...
    get '/project_item', to: 'app/front#project_item', as: :app_project_item
    get '/projects', to: 'app/front#projects', as: :app_projects
    get '/portfolio2', to: 'app/front#portfolio2', as: :app_portfolio2
