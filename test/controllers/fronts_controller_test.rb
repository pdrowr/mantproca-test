...
class FrontsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create front" do
    assert_difference('Front.count') do
      post fronts_url, params: { front: { aboutus: @front.aboutus, index: @front.index, portfolio2: @front.portfolio2, project-item: @front.project-item, projects: @front.projects } }
    end
  ...
  test "should update front" do
    patch front_url(@front), params: { front: { aboutus: @front.aboutus, index: @front.index, portfolio2: @front.portfolio2, project-item: @front.project-item, projects: @front.projects } }
