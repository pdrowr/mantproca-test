...
class FrontsTest < ApplicationSystemTestCase
  ...
  test "creating a Front" do
    ...
    fill_in "Aboutus", with: @front.aboutus
    fill_in "Index", with: @front.index
    fill_in "Portfolio2", with: @front.portfolio2
    fill_in "Project Item", with: @front.project-item
    fill_in "Projects", with: @front.projects
